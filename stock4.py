    ...
    try:
        ...
        with col_graf2:
            ...
            if len(productos_sobrantes) > 0 and col_cn:
                ...
                st.download_button(
                    label=f"📋 Descargar CNs Stock Sobrante ({len(productos_sobrantes)})",
                    data=cns_sobrantes,
        ...
        st.subheader("🎯 Análisis por Categorías - Comparativa Stock Ideal vs Actual")
        ...
        # ========== GRÁFICO 4: ANÁLISIS POR FAMILIAS - STOCK ACTUAL ==========
        if col_categoria_funcional and 'Familia' in df.columns and col_cn:
            ...
            # ========== GRÁFICO 6: DESGLOSE POR FAMILIA ESPECÍFICA Y SUBFAMILIAS ==========
            ...
            if familia_seleccionada:
                ...
                if tiene_subfamilias:
                    ...
                    # Gráfico de subfamilias
                    col_graf_sub1, col_graf_sub2 = st.columns(2)
                    
                    with col_graf_sub1:
                        # Gráfico de barras: Stock Actual vs Ideal por subfamilia
                        ...
                        fig_subfam_comp.update_layout(
                            title='Top 10 Subfamilias: Stock Actual vs Ideal',
                            barmode='group',
                            yaxis_title='Unidades',
